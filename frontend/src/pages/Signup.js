    ...
    <div className='p-3 md:p-4'>
        <div className='w-full max-w-sm bg-white m-auto flex flex-col p-4'>
          ...
          <div className='w-20 h-20 overflow-hidden rounded-full drop-shadow-md m-auto relative'>
            ...
            <div className='absolute bottom-0 height-1/3 bg-slate-500 bg-opacity-50 w-full text-center cursor-pointer'>
          ...
          <form className='w-full py-3 flex flex-col' onSubmit={handleSubmit}>
           ...
           <div className='flex px-2 py-1 bg-slate-200 rounded mt-1 mb-2 focus-within:outline focus-within:outline-blue-300'>
           <input type={showPassword ?'text':'password' }id='confirmPassword' name='confirmPassword' className='w-full bg-slate-200 border-none outline-none'  value={data.confirmPassword} onChange={handleOnChange}/> 
          ...
          <p className='text-left text-sm mt-2'>Already Registered? <Link to={'/login'} className='text-red-500 underline'>Login</Link></p>
        </div>
    </div>
  )
}
